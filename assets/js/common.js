  ...
  <nav class="navbarStyle navbar navbar-expand-lg navbar-light bg-white">
    <div class="container-fluid nav-inner-div">
      ...
      <ul class="dropdown-menu" aria-labelledby="pricingDropdown">
        ...
        <li><a class="dropdown-item" href="../Package/Digital-marketing.html">Digital Marketing</a></li>
                ...
                <div class="container">
                    <div class="footer-wrapper d-flex align-items-center justify-content-between">
                        <p class="wow fadeInLeft color-2" data-wow-delay=".3s">
                            © All Copyright 2025 by Digital Growthx
                        </p>
...
`;
const mouseCurzorDesignHTML = `    <div class="mouse-cursor cursor-outer"></div>
    <div class="mouse-cursor cursor-inner"></div>`;
document.querySelector("#header").innerHTML = headerHTML;
document.querySelector("#footer").innerHTML = footerHTML;
document.querySelector("body").innerHTML += backToTopHTML;
document.querySelector("body").innerHTML += mouseCurzorDesignHTML;
